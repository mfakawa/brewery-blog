    ...
    render() {
        return (
            <div id="contact">
                ...
                <div id="contact-content" className="jumbotron jumbotron-fluid bg-transparent mt-5 mt-md-0 mx-3 py-3 mx-sm-4 p-0 p-sm-4 mx-md-5 p-md-5 border-top border-bottom border-dark">
                    ...
                    <h2 className="mx-auto text-center"><a className=" text-dark" href="https://accounts.google.com" rel="noopener noreferrer">piecdziesiattwarzykrafta@gmial.com</a></h2>
                </div>
            </div>
        );
    }
