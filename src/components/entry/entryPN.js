...
const EntryPN = props => {
  const { otherEntry, id } = props;
  return (
    <div className="jumbotron p-0 m-0 bg-transparent">
      {otherEntry &&
        otherEntry.map((other, index, array) => {
          if (array.length > 1) {
            if (id === other.id) {
                    ...
                    <div className="col-xl-5 px-3 mx-3 mx-sm-4 mx-md-5">
                      <div className="row justify-content-center m-0">
                        <div className="col p-0">
                          <h2 className="title pb-2 px-2 mb-0 mx-sm-3 mx-lg-0 mt-sm-2 pb-md-3 display-4 font-weight-bold text-left border-bottom border-dark">
                            poprzedni artykół
                          </h2>
                        </div>
                      </div>
