...
class CreateEntry extends Component {
  ...
  handleOption = data => {
    this.setState({ option: data.target.value });
  };
              ...
              <div className="jumbotron jumbotron-fluid py-4 px-5 py-sm-5 mb-5">
                ...
                <form onSubmit={this.handleSubmit}>
                  <fieldset className="form-group">
                    <div className="row">
                      <legend className="col-form-label col-sm-3 col-md-2 pt-0">
                        Kategoria
                      </legend>
                      <div className="col-sm-9 col-md-10">
                        ...
                        <div className="form-check">
                          <input
                            ...
                            onChange={this.handleOption}
                          />
                          <label className="form-chect-label" htmlFor="option3">
                            Wydarzenia - relacja
                          </label>
                        </div>
                        <div className="form-check">
                          <input
                            ...
                            onChange={this.handleOption}
                          />
                          <label className="form-chect-label" htmlFor="option4">
                            Degustacje
                          </label>
                        </div>
                      </div>
                  ...
                  <div className="form-group row">
                    <label htmlFor="photo1" className="col-md-2 col-form-label">
                      Zdjęcie 1
                    </label>
                    <input
                      type="file"
                      className="form-control-file  col-md-10"
                      id="photo1"
                  ...
                  <div className="form-group row">
                    ...
                    <label
                      ...
                      className="col col-md-2 col-xl-2 col-form-label"
                    >
                      Opis zdjęcia 1
                    </label>
                    <input
                  ...
                  <div className="form-group row">
                    ...
                    <label
                      htmlFor="photo2"
                      className="col col-md-2 col-form-label"
                    >
                      Zdjęcie 2 (slider)
                    </label>
                    <input
                      type="file"
                      className="form-control-file col-md-9"
                      id="photo2"
                      onChange={this.handleImage}
                    />
                  </div>
                  ...
                  <div className="form-group row">
                    ...
                    <label
                      htmlFor="text2"
                      className="col col-md-2 col-xl-1 col-form-label"
                    >
                      Treść 2
                    </label>
                    <textarea
                      type="text"
                      className="form-control col-md-9 col-xl-10"
                      id="text2"
                      placeholder="wpisz treść..."
                      onChange={this.handleChange}
                    />
