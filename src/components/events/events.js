...
class Events extends Component {
    ...
    render() {
        ...
        return (
            <div id="events">
                <div id="events-head" className="jumbotron m-0 p-0">
                ...
                <div id="events-content">
                    <h1 className="pb-2 mb-0 mt-4 mx-2 mt-md-0 mb-md-4 mx-md-5 pb-md-3 display-4 font-weight-bold text-center text-dark border-bottom border-dark">Nadchodzące festiwale i wydarzenie</h1>
                    <div id="events-content-new-entries" className="jumbotron m-0  p-0 bg-transparent">
                    ...
                    <h1 className="pb-2 mb-0 mx-2 mt-4 mx-2 mb-md-4 mt-md-5 mx-md-5 pb-md-3 display-4 font-weight-bold text-center text-dark border-bottom border-dark">Relacje z minionych wydarzeń</h1>
                    <div id="events-content-old-entries" className="jumbotron m-0 p-0 bg-transparent">
                        <div className="row m-auto py-4 py-md-5 justify-content-center">
