          ...
          <div className="jumbotron jumbotron-fluid py-4 px-5 py-sm-5 mb-5 ">
            ...
            <form onSubmit={this.handleSubmit}>
              <div className="form-group row">
                ...
                <input
                  className="col-sm-9 col-md-10 form-control"
                  type="text"
                  id="firstName"
                  placeholder="imię..."
              ...
              <div className="form-group row">
                <label htmlFor="file" className="col-sm-3 col-md-2">
                  Zdjęcie profilowe:
                </label>
                <input
                  type="file"
                  className="col-sm-9 col-md-10 form-control-file"
                  id="file"
              ...
              <div className="row center">
                <div className="col">
                  {authError && authError !== "success" ? (
                    <p className="text-center mb-0 mt-4 text-danger">
                      {authError}
                    </p>
                  ) : null}
                </div>
